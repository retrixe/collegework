...
# --- START FIX ---
# Update the function to accept 'G' and 'df'
...
# --- END FIX ---
    ...
    # (This comment is now misleading, but we'll leave it)
        ...
        if G.nodes[uid]['node_type'] == 'user':
            ...
            for rid in user_rated_recipes:
                try:
                    ...
                    logging.warning(f"Could not parse recipe ID from graph node: {rid}")
                    continue
